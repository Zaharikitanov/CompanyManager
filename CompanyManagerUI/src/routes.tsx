...
import AddFacility from "./views/admin-area/Office/AddOffice";
import EditFacility from "./views/admin-area/Office/EditOffice";
import OfficeDetails from "./views/admin-area/Office/OfficeDetails";
